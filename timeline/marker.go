...
var (
	MarkerArrow    = MustParseGUID("C3A56F1E045E3848B07CBAC5BBDD2C32")
	MarkerCircle   = MustParseGUID("73C880AE431C9F4D8A5972ACF7066F4E")
	MarkerHeart    = MustParseGUID("185008E2437B184D8FDAD647DD972D9F")
	MarkerSquare   = MustParseGUID("6E5997457B3F6A45B984C613806FA72A")
	MarkerStar     = MustParseGUID("5140125657C6084D94226C8EC0216649")
	MarkerSpiral   = MustParseGUID("EBBE113AE2E53F4E96F3E92FB1353ECE")
	MarkerTriangle = MustParseGUID("46EBC4397F8A3740B900333B591F6183")
	MarkerX        = MustParseGUID("8BDCF5C47F8A8340A251F102AF3B5905")

	CommanderTagRed    = MustParseGUID("4242F370667CE54EB3BF22BE8D06F986")
	CommanderTagOrange = MustParseGUID("E57AAE9EE7FC5D458B0CF16BE4B096BF")
	CommanderTagYellow = MustParseGUID("AF9442A290C6214596E0B339EB3BDE92")
	CommanderTagGreen  = MustParseGUID("74AD480E531F4740A407879976C8CA91")
	CommanderTagCyan   = MustParseGUID("96F4AB5CDEC5294388375C7A03AB7614")
	CommanderTagBlue   = MustParseGUID("AE714FC5E4EA464C8961CD78E86F9291")
	CommanderTagPurple = MustParseGUID("1993FADB6FB70E4383A223A54D311F7D")
	CommanderTagPink   = MustParseGUID("E911D8C0EF2FDF4D8D252E5FB1283C62")
	CommanderTagWhite  = MustParseGUID("A59678CDFB5732439D7FCBF58D8BCEC3")

	CatmanderTagRed    = MustParseGUID("CA76AB023593B0448F692FE29DF03D17")
	CatmanderTagOrange = MustParseGUID("9FDF03E9BA09A2458C1EDDA4D81BC34D")
	CatmanderTagYellow = MustParseGUID("6BCE90E99016B448969EB317784A8334")
	CatmanderTagGreen  = MustParseGUID("2CA226E07262C743BA193ACF6F9D0AF6")
	CatmanderTagCyan   = MustParseGUID("A8072D65CE35924BABBAC831B12019D7")
	CatmanderTagBlue   = MustParseGUID("9B94F0FD616E7F4AA58EFDC8C59FB689")
	CatmanderTagPurple = MustParseGUID("7224A4AF710E4243BFE032629E17CA6E")
	CatmanderTagPink   = MustParseGUID("4387BE6146D43246AA7B333168EA58EA")
	CatmanderTagWhite  = MustParseGUID("A0B0EC076BC83B40A293C1CDEC4A7DE7")
)
...
// MustParseGUID parses a GUID literal of the tables above.
